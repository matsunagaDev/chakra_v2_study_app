...
import {
  Icon,
  mergeRefs
} from "./chunk-JHQCLR4Y.js";
import {
  hideOthers
} from "./chunk-TPNDOUUY.js";
import {
  callAllHandlers,
  chakra,
  createContext,
...
function handleHoverEvent(node2, event, isActive) {
  const { props } = node2;
...
function useVisualElement(Component3, visualState, props, createVisualElement, ProjectionNodeConstructor) {
  ...
  const wantsHandoff = (0, import_react10.useRef)(Boolean(optimisedAppearId) && !((_a2 = window.MotionHandoffIsComplete) === null || _a2 === void 0 ? void 0 : _a2.call(window, optimisedAppearId)) && ((_b = window.MotionHasOptimisedAnimation) === null || _b === void 0 ? void 0 : _b.call(window, optimisedAppearId)));
...
var Collapse = (0, import_react48.forwardRef)(
  (props, ref) => {
    ...
    return (0, import_jsx_runtime12.jsx)(AnimatePresence, { initial: false, custom, children: show && (0, import_jsx_runtime12.jsx)(
      motion.div,
      {
        ref,
        ...rest,
...
var Fade = (0, import_react49.forwardRef)(function Fade2(props, ref) {
  const {
    unmountOnExit,
    in: isOpen,
    className,
  ...
  return (0, import_jsx_runtime13.jsx)(AnimatePresence, { custom, children: show && (0, import_jsx_runtime13.jsx)(
    motion.div,
    {
      ref,
...
var ScaleFade = (0, import_react50.forwardRef)(
  function ScaleFade2(props, ref) {
    ...
    return (0, import_jsx_runtime14.jsx)(AnimatePresence, { custom, children: show && (0, import_jsx_runtime14.jsx)(
      motion.div,
      {
        ref,
...
var SlideFade = (0, import_react51.forwardRef)(
  function SlideFade2(props, ref) {
    ...
    return (0, import_jsx_runtime15.jsx)(AnimatePresence, { custom, children: show && (0, import_jsx_runtime15.jsx)(
      motion.div,
      {
        ref,
        className: cx("chakra-offset-slide", className),
...
var Slide = (0, import_react52.forwardRef)(function Slide2(props, ref) {
  const {
    direction = "right",
    style,
    unmountOnExit,
  ...
  return (0, import_jsx_runtime16.jsx)(AnimatePresence, { custom, children: show && (0, import_jsx_runtime16.jsx)(
    motion.div,
    {
      ...rest,
      ref,
...
var ModalTransition = (0, import_react53.forwardRef)(
  (props, ref) => {
    const { preset, motionProps = getMotionProps(preset), ...rest } = props;
    return (0, import_jsx_runtime17.jsx)(MotionSection, { ref, ...motionProps, ...rest });
  }
);
...
function useModal(props) {
  ...
  const mouseDownTarget = (0, import_react55.useRef)(null);
  const onMouseDown = (0, import_react55.useCallback)((event) => {
  ...
  const [headerMounted, setHeaderMounted] = (0, import_react55.useState)(false);
  const [bodyMounted, setBodyMounted] = (0, import_react55.useState)(false);
  const getDialogProps = (0, import_react55.useCallback)(
    (props2 = {}, ref = null) => ({
      role: "dialog",
      ...props2,
  ...
  const onOverlayClick = (0, import_react55.useCallback)(
    (event) => {
      event.stopPropagation();
  ...
  const getDialogContainerProps = (0, import_react55.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
...
function useIds(idProp, ...prefixes) {
  const reactId = (0, import_react55.useId)();
...
function PortalManager(props) {
  ...
  return (0, import_jsx_runtime18.jsx)(PortalManagerContextProvider, { value: { zIndex }, children });
}
...
var Container = (props) => (0, import_jsx_runtime19.jsx)(
  "div",
  {
...
var DefaultPortal = (props) => {
  ...
  const [tempNode, setTempNode] = (0, import_react56.useState)(null);
  const portal = (0, import_react56.useRef)(null);
  const [, forceUpdate] = (0, import_react56.useState)({});
  (0, import_react56.useEffect)(() => forceUpdate({}), []);
  ...
  const _children = (manager == null ? void 0 : manager.zIndex) ? (0, import_jsx_runtime19.jsx)(Container, { zIndex: manager == null ? void 0 : manager.zIndex, children }) : children;
  return portal.current ? (0, import_react_dom.createPortal)(
    (0, import_jsx_runtime19.jsx)(PortalContextProvider, { value: portal.current, children: _children }),
    portal.current
...
var ContainerPortal = (props) => {
  ...
  const portal = (0, import_react56.useMemo)(() => {
  ...
  if (host && portal) {
    return (0, import_react_dom.createPortal)(
      (0, import_jsx_runtime19.jsx)(PortalContextProvider, { value: appendToParentPortal ? portal : null, children }),
      portal
    );
  }
  return null;
...
function Portal(props) {
  ...
  return containerRef ? (0, import_jsx_runtime19.jsx)(ContainerPortal, { containerRef, ...rest }) : (0, import_jsx_runtime19.jsx)(DefaultPortal, { ...rest });
}
...
var Modal = (props) => {
  ...
  return (0, import_jsx_runtime20.jsx)(ModalContextProvider, { value: context, children: (0, import_jsx_runtime20.jsx)(ModalStylesProvider, { value: styles, children: (0, import_jsx_runtime20.jsx)(AnimatePresence, { onExitComplete: onCloseComplete, children: context.isOpen && (0, import_jsx_runtime20.jsx)(Portal, { ...portalProps, children }) }) }) });
};
...
var focusScope = (0, import_react60.createContext)(void 0);
...
var FocusLock = React9.forwardRef(function FocusLockUI(props, parentRef) {
  ...
  return React9.createElement(React9.Fragment, null, hasLeadingGuards && [
    ...
    focusOptions,
    noFocusGuards
  }), React9.createElement(Container2, _extends({
    ref: mergedRef
  }, lockProps, {
    className,
    onBlur: onBlur3,
  ...
  return function wrap2(WrappedComponent) {
    ...
    var SideEffect = function(_PureComponent) {
      ...
      _proto.render = function render() {
        return import_react61.default.createElement(WrappedComponent, this.props);
      };
      return SideEffect2;
...
var FocusLock2 = (props) => {
  ...
  const onActivation = (0, import_react64.useCallback)(() => {
  ...
  const onDeactivation = (0, import_react64.useCallback)(() => {
    var _a2;
...
var ModalContent = forwardRef(
  (props, ref) => {
    ...
    return (0, import_jsx_runtime23.jsx)(ModalFocusScope, { children: (0, import_jsx_runtime23.jsx)(
      chakra.div,
      {
        ...containerProps,
...
function AlertDialog(props) {
  ...
  return (0, import_jsx_runtime24.jsx)(Modal, { ...rest, initialFocusRef: leastDestructiveRef });
}
var AlertDialogContent = forwardRef(
  (props, ref) => (0, import_jsx_runtime24.jsx)(ModalContent, { ref, role: "alertdialog", ...props })
);
...
function Drawer(props) {
  ...
  return (0, import_jsx_runtime25.jsx)(DrawerContextProvider, { value: { placement }, children: (0, import_jsx_runtime25.jsx)(
    Modal,
    {
      isOpen,
      onClose,
...
var DrawerContent = forwardRef(
  (props, ref) => {
    ...
    return (0, import_jsx_runtime26.jsx)(ModalFocusScope, { children: (0, import_jsx_runtime26.jsx)(
      chakra.div,
      {
        ...containerProps,
        className: "chakra-modal__content-container",
...
function CloseIcon(props) {
  return (0, import_jsx_runtime31.jsx)(Icon, { focusable: "false", "aria-hidden": true, ...props, children: (0, import_jsx_runtime31.jsx)(
    "path",
    {
      fill: "currentColor",
  ...
  function CloseButton2(props, ref) {
    ...
    return (0, import_jsx_runtime31.jsx)(
      chakra.button,
      {
        ...
        ...rest,
        children: children || (0, import_jsx_runtime31.jsx)(CloseIcon, { width: "1em", height: "1em" })
      }
    );
  }
);
